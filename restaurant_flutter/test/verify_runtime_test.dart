...
void main() {
  test('Supabase Verification Test', () async {
    TestWidgetsFlutterBinding.ensureInitialized();
    SharedPreferences.setMockInitialValues({});
    
    final url = 'https://pegmlyoebbgzbvcivntb.supabase.co';
    final key = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBlZ21seW9lYmJnemJ2Y2l2bnRiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODE4OTA5MTcsImV4cCI6MjA5NzQ2NjkxN30.Am2dDtIZJKaqnaKIPSCM0W5O1EyWHgj7xtN4jVsla5o';
